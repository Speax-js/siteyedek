...
const IDler = {
  botID: "788649948409233418",
  botSecret: "tRo0EPlSQiBJVvMxxvwcjbVMvBYZuRSj",
  botCallbackURL: "https://speaxcode.glitch.me/callback",
  sunucuID: "791725173174304798",
  sunucuDavet: "https://discord.com/invite/nh3JT3SZAH",
  kodLogKanalı: "806928048079241216",
  sahipRolü: "794860213982199818",
  adminRolü: "797862207051268150",
  kodPaylaşımcıRolü: "806928293517197392",
  boosterRolü: "791726886979764264",
  kodPaylaşamayacakRoller: ["794860219741896714", "794860219741896714"],
  hazırAltyapılarRolü: "806928859517157406",
  hazırSistemlerRolü: "806928922910523462",
  sistemlerrolü: "806483896400871445",
  elmasKodlarRolü: "806928940735397938",
  altınKodlarRolü: "806928965234720779",
  normalKodlarRolü: "794860225688633364"
};
...
app.post("/paylasim", (req, res) => {
  ...
  client.channels.cache.get(IDler.kodLogKanalı).send(
    new Discord.MessageEmbed()
      ...
      .addField(
        "Kod Sayfası",
        `[Tıkla!](https://revenge-code-paylam-sitex.glitch.me/${obj.kod_rank}/${obj.id})`
      )
  );
...
client.on("ready", () => {
  const listener = app.listen(process.env.PORT, function() {
    client.user.setActivity(`Revege Code`, { type: "WATCHING" });
